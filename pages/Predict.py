...
# Set form header
st.markdown("<h2 style='text-align: center;'>Please enter your details(If You want the report)</h2>", unsafe_allow_html=True)
...
if submit:
    if img is None:
        st.info("No image uploaded. Using default sample.png.")
        img_path = "sample.png"  # Make sure this is in your repo root
    ...
    c.drawCentredString(125,20,"Anurag Nepal")
    # For under lining the title
    c.line(70,22,180,22)
    # Changing the font size for Specifying Address
    c.setFont("Helvetica-Bold",5)
    c.drawCentredString(125,30,"Malaria Report")
